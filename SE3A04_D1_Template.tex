...
\subsection{Purpose}
\label{sub:purpose}
The purpose of this document is to identify software requirements, background info regarding the product and its users, and use cases. \\
The intended audience for this document is internal stakeholders on the project, such as developers, managers, executives, investors, domain experts, and anybody involved in the development of MushFind. Note that there is no prior knowledge required.  
...
\begin{itemize}
	...
	\item Text Description Expert: This expert will use textual descriptions of the mushroom, the location of the mushroom and other relevant information to identify the mushroom using a natural language processing model (NLP). The user will be required to input the textual information into the application. 
\end{itemize}
...
\begin{center}
	...
	\begin{tabular}{|m{4cm}|m{4cm}|m{6cm}|} % 'm{}' centers vertically
		\hline
		\textbf{Name} & \textbf{Student Number} & \textbf{Signature} \\
		\hline
		Aiden Lao & StudentNo & \\ 
		\hline
		Omar Alam & 400238260 & \includegraphics[scale=0.4]{omar-signature.png} \\ 
		\hline
		Luka Mahrt-Smith & StudentNo & \\ 
		\hline
		Farid Bastoros & StudentNo & \\ 
		\hline
		Neha Bhatia & StudentNo & \\ 
		\hline
	\end{tabular}
\end{center}
