...
\begin{itemize}
	...
	% 	\hline
	% 	Task & Section 4 - Did Half of the CRC Cards & Task & Task & Task & Task \\
	% 	\hline
	% 	Task & Section 1 - Reviewed and updated 1.1 and 1.3 & Task & Task & Task & Task \\
	% 	\hline
	% 	Task & Section 2 - Added Half of the classes to the Analyis Class Diagram  & Task & Task & Task & Task \\
	% 	\hline
